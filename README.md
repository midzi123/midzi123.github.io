...
<head>
  ...
  <meta name="description" content="Minimal one-page portfolio: About, Work, Photos." />
  ...
  <style>
    ...
    body{
      ...
      background: radial-gradient(1200px 800px at 80% -10%, rgba(125,211,252,.06), transparent 60%),
                  radial-gradient(1000px 600px at 10% 110%, rgba(165,180,252,.08), transparent 60%),
                  var(--bg);
      color: var(--text);
      line-height: 1.6;
    }
    ...
    .btn{
      ...
      box-shadow: 0 6px 16px color-mix(in srgb, var(--link) 35%, transparent);
